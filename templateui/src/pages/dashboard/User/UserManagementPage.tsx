...
import { UPDATE_USER_URL, USERS_LIST_URL } from '../../../utils/globalConfig';
...
import { IAuthUser, IUpdateUserDetailsDto } from '../../../types/auth.type';
...
const UsersManagementPage = ({selectedUsername}:IProps) => {
  ...
  const UpdateUserDetails = async (
    id: number,
    updatedData: IUpdateUserDetailsDto
  ) => {
